...
const Sidebar = () => (
  <div className="left-header">
    ...
    <div className="menu-container">
      {["Client", "My Client", "Individual", "Business"].map((item, index) => (
...
const StatsCards = () => (
  <div className="AllCard">
    {["Total Clients", "Individual User", " Business User", "Total Receivable (Get)"].map((label, index) => {
      let value = 1000;
      let change = "↑ 15%";
        ...
        const docxContent = filteredParties.map(
          (party) =>
            new Paragraph({
              children: [
                new TextRun({
                  text: `Client ID: ${party.partyId}, Client Name: ${party.partyName}, GSTIN: ${party.gstin}, Authorized Person: ${party.authorizedPerson}, Email: ${party.email}, Phone: ${party.phone}, Address: ${party.address}, State Code: ${party.stateCode}, Outstanding Balance: ${party.outstandingBalance}, Notes: ${party.notes}, Status: ${party.status}`,
                }),
              ],
            })
        );
      ...
      <div className="controls-container">
        ...
        <div className="search-by-dropdown">
          <select value={searchBy} onChange={handleSearchBy}>
            <option value="partyId">Client ID</option>
            <option value="partyName">Client Name</option>
