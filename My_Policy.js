...
const Header = () => (
  <header className="p-3 bg-dark text-white" id="upperHeader">
    ...
    <div className="welcome d-flex justify-content-between align-items-center mt-2">
      <strong className="me-auto">My Policy</strong>
...
const Sidebar = () => (
  <div className="left-header">
    ...
    <div className="menu-container">
      {["Policy", "My Policy"].map((item, index) => (
...
const StatsItems = () => (
     <div className="stats-cards-container">
      <div className="stats-card category">Term & Condition</div>
      <div className="stats-card sub-category">Privacy Policy</div>
      <div className="stats-card name-title">Title 1</div>
      <div className="stats-card name-title">Title 2</div>
    </div>
);
