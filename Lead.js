...
const Sidebar = () => (
  <div className="left-header">
    ...
    <div className="menu-container">
      {["Supplier", "My Supplier", "Individual", "Business"].map((item, index) => (
...
const StatsCards = () => (
  <div className="AllCard">
    {[" New Prospect", "Contacted", "Engaged/Follow-Up", "Qualified", "Disqualified", "Total Prospect"].map((label, index) => {
      let value = 1000;
      let change = "↑ 15%";
  ...
  const [partiesData, setPartiesData] = useState([
    {
      ...
      authorizerFatherName: "John Doe Sr.", // New field
    ...
    },
    {
      ...
      authorizerFatherName: "Alice Smith Sr.", // New field
      ...
      upiId: "alice.smith@upi", // New field
    ...
    },
    {
      ...
      authorizerFatherName: "Bob Johnson Sr.", // New field
        ...
        const docxContent = filteredParties.map(
          (party) =>
            new Paragraph({
              children: [
                new TextRun({
                  text: `Supplier ID: ${party.partyId}, Supplier Name: ${party.partyName}, GSTIN: ${party.gstin}, Authorized Person: ${party.authorizedPerson}, Email: ${party.email}, Phone: ${party.phone}, Address: ${party.address}, State Code: ${party.stateCode}, Outstanding Balance: ${party.outstandingBalance}, Notes: ${party.notes}, Status: ${party.status}`,
                }),
              ],
            })
        );
      ...
      <div className="controls-container">
        ...
        <div className="search-by-dropdown">
          <select value={searchBy} onChange={handleSearchBy}>
            <option value="partyId">Supplier ID</option>
            <option value="partyName">Supplier Name</option>
  ...
  <tbody>
    {filteredParties.map((party, index) => (
      <tr key={index}>
        ...
        <td>{party.supplierId}</td>
        <td>{party.partyName}</td>
        <td>{party.gstin}</td>
        <td>{party.authorizerFatherName}</td> {/* New field */}
        <td>{party.email}</td>
        <td>{party.phone}</td>
